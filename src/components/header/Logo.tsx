    ...
    <div>
      <Link href="/" className="flex items-center gap-2.5 no-underline shrink-0 group">
        ...
        <div className="flex flex-col justify-center">
          <p className="hdr-serif text-[18px] sm:text-[22px] font-extrabold text-[#093C5D] leading-none tracking-tight">
            Neelgiri Public
          </p>
          <p className="block text-[7.5px] sm:text-[9px] uppercase tracking-[0.05em] text-[#06283D] font-bold mt-0.5 sm:mt-1">
