          ...
          {!activeYear ? (
            <>
              <input 
                ...
                className="px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-teal-500 w-full sm:w-36 transition-all"
              />
              <button 
                onClick={() => handleAction('open')} disabled={loading}
                className="bg-teal-600 hover:bg-teal-700 text-white px-5 py-2 rounded-xl text-xs font-semibold transition-all border-0 cursor-pointer disabled:opacity-70 whitespace-nowrap shadow-xs"
              >
