...
export default function StreamsNav({ active, setActive }: StreamsNavProps) {
  ...
  return (
    <div className="flex justify-center px-4">
      <div className="relative flex bg-white/70 backdrop-blur-md border border-slate-200 rounded-full p-1.5 gap-1 shadow-sm w-full max-w-xs sm:max-w-md lg:max-w-lg">
        {/* SLIDING INDICATOR */}
        <motion.div
          layout
          transition={{ type: "spring", stiffness: 400, damping: 30 }}
          className="absolute top-1.5 bottom-1.5 rounded-full bg-cyan-500 shadow-md shadow-cyan-500/25"
          style={{
