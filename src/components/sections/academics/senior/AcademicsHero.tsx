...
export default function AcademicsHero() {
  ...
  const images = [
    { src: "/assets/academics/senior/biology_lab.png", title: "Biology Laboratory" },
    { src: "/assets/academics/senior/chemistry_lab.jpg", title: "Chemistry Laboratory" },
    { src: "/assets/academics/senior/physics_lab.jpg", title: "Physics Laboratory" },
    { src: "/assets/academics/senior/school_building.jpg", title: "School Building" },
  ];
  ...
  const handleExploreClick = () => {
    const el = document.getElementById("streams-section");
    if (el) {
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <motion.span
              ...
              className="inline-flex items-center px-3.5 py-1.5 rounded-full text-[#093C5D] text-[10px] sm:text-[11px] font-bold tracking-[0.14em] uppercase border border-[#093C5D]/15 bg-[#093C5D]/5 backdrop-blur-xs"
            >
              HPBOSE Affiliated
            </motion.span>
            ...
            <motion.h1
              ...
              className="text-[#06283D] font-black leading-[1] text-[2.1rem] xs:text-[2.4rem] sm:text-[3.2rem] md:text-[4rem] lg:text-[4.5rem]"
            >
              Excellence In<br />
              <span className="text-[#FA6781]">Classes 11 &amp; 12</span>
            </motion.h1>
            ...
            >
              Our Senior Secondary program provides high-quality academic preparation for students of Classes 11 and 12 with expert faculty, modern learning methods, career-focused guidance, and strong conceptual understanding specializing in Medical and Non-Medical streams.
            </motion.p>
              ...
              {images.map((img, idx) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/35 to-transparent p-5 pt-12 flex flex-col justify-end rounded-b-2xl">
                    ...
                    <p className="text-xs text-white/90 mt-0.5 font-medium">Classes XI &amp; XII practicals</p>
                  </div>
                </div>
              ))}
