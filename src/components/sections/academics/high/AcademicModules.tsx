...
import { Dna, FlaskConical, Calculator, MonitorSmartphone, Globe2, BookOpen } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7">
          {modules.map((module, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -3 }}
              className="group relative bg-white border border-[#093C5D]/20 rounded-[28px] overflow-hidden shadow-lg hover:shadow-xl transition duration-500 cursor-pointer"
            >
              {/* Top Image */}
